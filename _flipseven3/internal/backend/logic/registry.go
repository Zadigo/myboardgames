...
// It maintains a mapping of game UUIDs to their corresponding game states, which are
...
type GameRegistry struct {
	...
	CardQueue *CardQueue                  `json:"cardQueue"`
...
func (s *ServerRegistry) GetClientByUuid(clientUuid string) *WebsocketClient {
	s.mu.Lock()
	defer s.mu.Unlock()
	return s.clients[clientUuid]
}
